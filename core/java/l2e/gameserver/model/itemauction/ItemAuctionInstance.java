	...
	final void onAuctionFinished(final ItemAuction auction)
	{
		...
		if (bid != null)
		{
			...
			else
			{
				...
				_log.log(Level.INFO, getClass().getSimpleName() + ": Auction " + auction.getAuctionId() + " has finished. Highest bid by " + CharNameHolder.getInstance().getNameById(bid.getPlayerObjId()) + " for instance " + _instanceId);
			}
