		...
		else if (condition == COND_OWNER)
		{
			...
			if (actualCommand.equalsIgnoreCase("expel"))
			{
				if ((player.getClanPrivileges() & L2Clan.CP_CS_DISMISS) == L2Clan.CP_CS_DISMISS)
				{
					...
					html.setFile(player.getLang(), "data/html/fortress/foreman-expel.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					player.sendPacket(html);
				}
				else
				{
					NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getLang(), "data/html/fortress/foreman-noprivs.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					player.sendPacket(html);
				}
				return;
			...
			else if (actualCommand.equalsIgnoreCase("banish_foreigner"))
			{
				if ((player.getClanPrivileges() & L2Clan.CP_CS_DISMISS) == L2Clan.CP_CS_DISMISS)
				{
					...
					NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getLang(), "data/html/fortress/foreman-expeled.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					player.sendPacket(html);
				}
				else
			...
			else if (actualCommand.equalsIgnoreCase("receive_report"))
			{
				...
				{
					NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getLang(), "data/html/fortress/foreman-report.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
				...
				{
					NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
					html.setFile(player.getLang(), "data/html/fortress/foreman-castlereport.htm");
					html.replace("%objectId%", String.valueOf(getObjectId()));
					int hour, minutes;
					if (Config.FS_MAX_OWN_TIME > 0)
					{
			...
			else if (actualCommand.equalsIgnoreCase("operate_door"))
			{
				if ((player.getClanPrivileges() & L2Clan.CP_CS_OPEN_DOOR) == L2Clan.CP_CS_OPEN_DOOR)
				{
					if (!val.isEmpty())
					{
						...
						{
							NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
							html.setFile(player.getLang(), "data/html/fortress/foreman-opened.htm");
							html.replace("%objectId%", String.valueOf(getObjectId()));
							player.sendPacket(html);
						}
						else
						{
							NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
							html.setFile(player.getLang(), "data/html/fortress/foreman-closed.htm");
							html.replace("%objectId%", String.valueOf(getObjectId()));
							player.sendPacket(html);
						}
					}
					...
					{
						NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
						html.setFile(player.getLang(), "data/html/fortress/" + getTemplate().getId() + "-d.htm");
						html.replace("%objectId%", String.valueOf(getObjectId()));
				...
				if ((player.getClanPrivileges() & L2Clan.CP_CL_VIEW_WAREHOUSE) == L2Clan.CP_CL_VIEW_WAREHOUSE)
				{
					...
					else if (val.equalsIgnoreCase("withdraw"))
					{
						if (Config.ENABLE_WAREHOUSESORTING_CLAN)
						{
							...
							String htmContent = HtmCache.getInstance().getHtm(player.getLang(), htmFile);
							if (htmContent != null)
							{
					...
					{
						html.setFile(player.getLang(), "data/html/fortress/foreman-vault.htm");
			...
			else if (actualCommand.equalsIgnoreCase("functions"))
			{
				if (val.equalsIgnoreCase("tele"))
				{
					...
					{
						html.setFile(player.getLang(), "data/html/fortress/foreman-nac.htm");
					}
					else
					{
						html.setFile(player.getLang(), "data/html/fortress/" + getId() + "-t" + getFort().getFunction(Fort.FUNC_TELEPORT).getLvl() + ".htm");
					}
					sendHtmlMessage(player, html);
				}
				else if (val.equalsIgnoreCase("support"))
				{
					...
					{
						html.setFile(player.getLang(), "data/html/fortress/support" + getFort().getFunction(Fort.FUNC_SUPPORT).getLvl() + ".htm");
				...
				{
					NpcHtmlMessage html = new NpcHtmlMessage(1);
					html.setFile(player.getLang(), "data/html/fortress/foreman-functions.htm");
				...
				if ((player.getClanPrivileges() & L2Clan.CP_CS_SET_FUNCTIONS) == L2Clan.CP_CS_SET_FUNCTIONS)
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						if (st.countTokens() >= 1)
						{
							...
							{
								NpcHtmlMessage html = new NpcHtmlMessage(1);
								html.setFile(player.getLang(), "data/html/fortress/functions-cancel.htm");
							...
							else if (val.equalsIgnoreCase("edit_hp"))
							{
								val = st.nextToken();
								NpcHtmlMessage html = new NpcHtmlMessage(1);
								html.setFile(player.getLang(), "data/html/fortress/functions-apply.htm");
							...
							else if (val.equalsIgnoreCase("hp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									val = st.nextToken();
									NpcHtmlMessage html = new NpcHtmlMessage(1);
									html.setFile(player.getLang(), "data/html/fortress/functions-apply_confirmed.htm");
									if (getFort().getFunction(Fort.FUNC_RESTORE_HP) != null)
									{
										if (getFort().getFunction(Fort.FUNC_RESTORE_HP).getLvl() == Integer.parseInt(val))
										{
											html.setFile(player.getLang(), "data/html/fortress/functions-used.htm");
									...
									switch (percent)
									{
										case 0:
											fee = 0;
											html.setFile(player.getLang(), "data/html/fortress/functions-cancel_confirmed.htm");
											break;
										case 300:
									...
									{
										html.setFile(player.getLang(), "data/html/fortress/low_adena.htm");
										sendHtmlMessage(player, html);
									}
									sendHtmlMessage(player, html);
								}
						...
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player.getLang(), "data/html/fortress/edit_recovery.htm");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player.getLang(), "data/html/fortress/edit_other.htm");
					...
					{
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player.getLang(), "data/html/fortress/manage.htm");
						sendHtmlMessage(player, html);
					}
				}
				else
				...
				try
				{
					...
					try
					{
						...
						else
						{
							...
							{
								html.setFile(player.getLang(), "data/html/fortress/support-no_mana.htm");
								html.replace("%mp%", String.valueOf((int) getCurrentMp()));
								sendHtmlMessage(player, html);
								return;
							}
						}
						html.setFile(player.getLang(), "data/html/fortress/support-done.htm");
						html.replace("%mp%", String.valueOf((int) getCurrentMp()));
						sendHtmlMessage(player, html);
					}
					catch (Exception e)
