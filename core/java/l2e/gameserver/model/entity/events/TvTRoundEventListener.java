...
public final class TvTRoundEventListener extends EventListener
{
	protected TvTRoundEventListener(L2PcInstance player)
	{
		super(player);
	}
	...
	{
		return TvTEvent.isStarted() && TvTRoundEvent.isPlayerParticipant(getPlayer().getObjectId());
	}
