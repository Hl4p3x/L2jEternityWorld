...
import l2e.gameserver.network.serverpackets.AdminForgePacket;
...
public class AdminPForge implements IAdminCommandHandler
{
	...
	private void showMainPage(L2PcInstance activeChar)
	{
		...
		adminhtm.setFile(activeChar.getLang(), "data/html/admin/pforge1.htm");
	...
	private void showPage2(L2PcInstance activeChar, String format)
	{
		...
		adminReply.setFile(activeChar.getLang(), "data/html/admin/pforge2.htm");
	...
	{
		NpcHtmlMessage adminReply = new NpcHtmlMessage(5);
		adminReply.setFile(activeChar.getLang(), "data/html/admin/pforge3.htm");
		adminReply.replace("%format%", format);
