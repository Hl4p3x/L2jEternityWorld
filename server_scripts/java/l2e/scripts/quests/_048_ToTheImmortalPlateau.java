...
{
	private static final String qn = "_048_ToTheImmortalPlateau";
	...
	public _048_ToTheImmortalPlateau(int questId, String name, String descr)
	{
		...
		questItemIds = new int[] { GALLADUCCIS_ORDER_DOCUMENT_ID_1, GALLADUCCIS_ORDER_DOCUMENT_ID_2, GALLADUCCIS_ORDER_DOCUMENT_ID_3, 
	...
	{
		new _048_ToTheImmortalPlateau(48, qn, "");
	}
}
