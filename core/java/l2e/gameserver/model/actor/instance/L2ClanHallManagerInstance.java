		...
		if (condition == COND_OWNER)
		{
			...
			if (actualCommand.equalsIgnoreCase("banish_foreigner"))
			{
				...
				if ((player.getClanPrivileges() & L2Clan.CP_CH_DISMISS) == L2Clan.CP_CH_DISMISS)
				{
					...
					{
						html.setFile(player.getLang(), "data/html/clanHallManager/banish-list.htm");
					}
					else if (val.equalsIgnoreCase("banish"))
					{
						getClanHall().banishForeigners();
						html.setFile(player.getLang(), "data/html/clanHallManager/banish.htm");
					}
				}
				else
				{
					html.setFile(player.getLang(), "data/html/clanHallManager/not_authorized.htm");
				}
			...
			else if (actualCommand.equalsIgnoreCase("manage_vault"))
			{
				...
				if ((player.getClanPrivileges() & L2Clan.CP_CL_VIEW_WAREHOUSE) == L2Clan.CP_CL_VIEW_WAREHOUSE)
				{
					...
					{
						html.setFile(player.getLang(), "data/html/clanHallManager/vault-chs.htm");
					}
					else
					{
						html.setFile(player.getLang(), "data/html/clanHallManager/vault.htm");
			...
			else if (actualCommand.equalsIgnoreCase("door"))
			{
				...
				if ((player.getClanPrivileges() & L2Clan.CP_CH_OPEN_DOOR) == L2Clan.CP_CH_OPEN_DOOR)
				{
					if (val.equalsIgnoreCase("open"))
					{
						...
						html.setFile(player.getLang(), "data/html/clanHallManager/door-open.htm");
					}
					else if (val.equalsIgnoreCase("close"))
					{
						getClanHall().openCloseDoors(false);
						html.setFile(player.getLang(), "data/html/clanHallManager/door-close.htm");
					}
					else
					{
						html.setFile(player.getLang(), "data/html/clanHallManager/door.htm");
					}
					sendHtmlMessage(player, html);
				}
				else
			...
			else if (actualCommand.equalsIgnoreCase("functions"))
			{
				if (val.equalsIgnoreCase("tele"))
				{
					...
					{
						html.setFile(player.getLang(), "data/html/clanHallManager/chamberlain-nac.htm");
					}
					else
					{
						...
						{
							case 21:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Resistance" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 22:
							case 23:
							case 24:
							case 25:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Gludio" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 26:
							case 27:
							case 28:
							case 29:
							case 30:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Gludin" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 31:
							case 32:
							case 33:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Dion" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 34:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Devastated" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 35:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Bandit" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 36:
							case 37:
							case 38:
							...
							case 40:
							case 41:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Aden" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 42:
							case 43:
							case 44:
							case 45:
							case 46:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Giran" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 47:
							case 48:
							case 49:
							case 50:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Goddard" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 51:
							case 52:
							case 53:
							...
							case 56:
							case 57:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Rune" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 58:
							case 59:
							case 60:
							case 61:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Schuttgart" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 62:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Rainbow" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 63:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Beast" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
							case 64:
								html.setFile(player.getLang(), "data/html/clanHallManager/tele" + "Fortress" + getClanHall().getFunction(ClanHall.FUNC_TELEPORT).getLvl() + ".htm");
								break;
						}
					}
					sendHtmlMessage(player, html);
				...
				else if (val.equalsIgnoreCase("support"))
				{
					...
					{
						html.setFile(player.getLang(), "data/html/clanHallManager/support" + getClanHall().getFunction(ClanHall.FUNC_SUPPORT).getLvl() + ".htm");
				...
				{
					NpcHtmlMessage html = new NpcHtmlMessage(1);
					html.setFile(player.getLang(), "data/html/clanHallManager/functions.htm");
				...
				if ((player.getClanPrivileges() & L2Clan.CP_CH_SET_FUNCTIONS) == L2Clan.CP_CH_SET_FUNCTIONS)
				{
					if (val.equalsIgnoreCase("recovery"))
					{
						if (st.countTokens() >= 1)
						{
							...
							{
								NpcHtmlMessage html = new NpcHtmlMessage(1);
								html.setFile(player.getLang(), "data/html/clanHallManager/functions-cancel.htm");
							...
							else if (val.equalsIgnoreCase("edit_hp"))
							{
								val = st.nextToken();
								NpcHtmlMessage html = new NpcHtmlMessage(1);
								html.setFile(player.getLang(), "data/html/clanHallManager/functions-apply.htm");
							...
							else if (val.equalsIgnoreCase("hp"))
							{
								if (st.countTokens() >= 1)
								{
									...
									val = st.nextToken();
									NpcHtmlMessage html = new NpcHtmlMessage(1);
									html.setFile(player.getLang(), "data/html/clanHallManager/functions-apply_confirmed.htm");
									if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP) != null)
									{
										if (getClanHall().getFunction(ClanHall.FUNC_RESTORE_HP).getLvl() == Integer.parseInt(val))
										{
											html.setFile(player.getLang(), "data/html/clanHallManager/functions-used.htm");
									...
									switch (percent)
									{
										case 0:
											fee = 0;
											html.setFile(player.getLang(), "data/html/clanHallManager/functions-cancel_confirmed.htm");
											break;
										case 20:
									...
									{
										html.setFile(player.getLang(), "data/html/clanHallManager/low_adena.htm");
										sendHtmlMessage(player, html);
									}
									else
									{
						...
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player.getLang(), "data/html/clanHallManager/edit_recovery.htm");
					...
					else if (val.equalsIgnoreCase("other"))
					{
						...
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player.getLang(), "data/html/clanHallManager/edit_other.htm");
					...
					else if (val.equalsIgnoreCase("deco") && !getClanHall().isSiegableHall())
					{
						...
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player.getLang(), "data/html/clanHallManager/deco.htm");
					...
					{
						NpcHtmlMessage html = new NpcHtmlMessage(1);
						html.setFile(player.getLang(), getClanHall().isSiegableHall() ? "data/html/clanHallManager/manage_siegable.htm" : "data/html/clanHallManager/manage.htm");
						sendHtmlMessage(player, html);
					}
				}
				else
				...
				try
				{
					...
					try
					{
						...
						else
						{
							...
							{
								NpcHtmlMessage html = new NpcHtmlMessage(1);
								html.setFile(player.getLang(), "data/html/clanHallManager/support-no_mana.htm");
								html.replace("%mp%", String.valueOf((int) getCurrentMp()));
								sendHtmlMessage(player, html);
								return;
							}
						...
						html.setFile(player.getLang(), "data/html/clanHallManager/support-done.htm");
						html.replace("%mp%", String.valueOf((int) getCurrentMp()));
						sendHtmlMessage(player, html);
					}
					catch (Exception e)
