	...
	public String onEnterWorld(L2PcInstance player)
	{
		...
		if (player.isSubClassActive())
		{
			if (certSkills != null)
			{
				...
				{
					Util.handleIllegalPlayerAction(player, "Player " + player.getName() + " has cert skill on subclass :" + s.getName() + "(" + s.getId() + "/" + s.getLevel() + "), class:" + ClassListParser.getInstance().getClass(player.getClassId()).getClassName(), 0);
