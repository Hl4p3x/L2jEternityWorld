...
public class Hero
{
	...
	public void loadDiary(int charId)
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			_log.info("Hero System: Loaded " + diaryentries + " diary entries for Hero: " + CharNameHolder.getInstance().getNameById(charId));
		}
		catch (SQLException e)
		{
	...
	public void loadFights(int charId)
	{
		...
		try (Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			_log.info("Hero System: Loaded " + numberoffights + " fights for Hero: " + CharNameHolder.getInstance().getNameById(charId));
		}
		catch (SQLException e)
		{
	...
	public void showHeroDiary(L2PcInstance activeChar, int heroclass, int charid, int page)
	{
		...
		if (_herodiary.containsKey(charid))
		{
			...
			final String htmContent = HtmCache.getInstance().getHtm(activeChar.getLang(), "data/html/olympiad/herodiary.htm");
	...
	public void showHeroFights(L2PcInstance activeChar, int heroclass, int charid, int page)
	{
		...
		if (_herofights.containsKey(charid))
		{
			...
			final String htmContent = HtmCache.getInstance().getHtm(activeChar.getLang(), "data/html/olympiad/herohistory.htm");
			if (htmContent != null)
			{
