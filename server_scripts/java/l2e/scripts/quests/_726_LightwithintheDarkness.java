...
/**
 * Created by LordWinter 21.02.2013 Based on L2J Eternity-World
 */
public class _726_LightwithintheDarkness extends Quest
{
	...
	protected void FirstWave(final PAWORLD world)
	{
		ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
		{
			...
			public void run()
			{
				addSpawn(SEDUCED_KNIGHT, 49384, -12232, -9384, 0, false, 0, false, world.instanceId);
				addSpawn(SEDUCED_RANGER, 49192, -12232, -9384, 0, false, 0, false, world.instanceId);
				addSpawn(SEDUCED_MAGE, 49192, -12456, -9392, 0, false, 0, false, world.instanceId);
				addSpawn(SEDUCED_WARRIOR, 49192, -11992, -9392, 0, false, 0, false, world.instanceId);
				addSpawn(KANADIS_GUIDE1, 50536, -12232, -9384, 32768, false, 0, false, world.instanceId);
				broadCastPacket(world, new ExShowScreenMessage(NpcStringId.BEGIN_STAGE_1, 2, 3000));
				for (int i = 0; i < 10; i++)
				{
					addSpawn(KANADIS_FOLLOWER1, 50536, -12232, -9384, 32768, false, 0, false, world.instanceId);
				}
				ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
				{
					@Override
	...
	protected void SecondWave(final PAWORLD world)
	{
		...
		addSpawn(KANADIS_GUIDE2, 50536, -12232, -9384, 32768, false, 0, false, world.instanceId);
		for (int i = 0; i < 10; i++)
		{
			addSpawn(KANADIS_FOLLOWER2, 50536, -12232, -9384, 32768, false, 0, false, world.instanceId);
		}
		ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
		{
			@Override
	...
	protected void ThirdWave(final PAWORLD world)
	{
		...
		addSpawn(KANADIS_GUIDE3, 50536, -12232, -9384, 32768, false, 0, false, world.instanceId);
		addSpawn(KANADIS_GUIDE3, 50536, -12232, -9384, 32768, false, 0, false, world.instanceId);
		for (int i = 0; i < 10; i++)
		{
			addSpawn(KANADIS_FOLLOWER3, 50536, -12232, -9384, 32768, false, 0, false, world.instanceId);
		}
	}
