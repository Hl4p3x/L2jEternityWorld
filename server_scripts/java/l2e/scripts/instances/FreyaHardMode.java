...
public class FreyaHardMode extends Quest
{
	...
	public FreyaHardMode(int questId, String name, String descr)
	{
	...
	protected void callSkillAI(L2Npc mob)
	{
		int[][] freya_skills =
		{
		                {
	...
	{
		new FreyaHardMode(-1, FreyaHardMode.class.getSimpleName(), "instances");
	}
}
