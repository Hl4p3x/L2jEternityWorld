...
public final class KamaelOccupationChange extends Quest
{
	...
	public String onTalk(final L2Npc npc, final L2PcInstance player)
	{
		...
		if (race == 5)
		{
			...
			else if (ArrayUtils.contains(NPCS_MALE1, npcId))
			{
				if (id == 123)
				{
			...
			else if (ArrayUtils.contains(NPCS_FEMALE1, npcId))
			{
				if (id == 124)
				{
			...
			else if (ArrayUtils.contains(NPCS_MALE2, npcId))
			{
				if (id == 125)
				{
			...
			else if (ArrayUtils.contains(NPCS_FEMALE2, npcId))
			{
				if (id == 126)
				{
