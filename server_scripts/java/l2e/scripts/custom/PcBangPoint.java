	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if (POINTSSKILL.containsKey(event))
		{
			...
			else if (player.getPcBangPoints() >= POINTSSKILL.get(event)[2])
			{
				...
				npc.doCast(SkillHolder.getInstance().getInfo(POINTSSKILL.get(event)[0], POINTSSKILL.get(event)[1]));
		...
		else if (PETSKILL.containsKey(event))
		{
			...
			else if (player.getPcBangPoints() >= PETSKILL.get(event)[2])
			{
				...
				npc.doCast(SkillHolder.getInstance().getInfo(PETSKILL.get(event)[0], PETSKILL.get(event)[1]));
		...
		else if (event.equalsIgnoreCase("wyvern"))
		{
			if (player.getPcBangPoints() >= 2500)
			{
				...
				player.addSkill(SkillHolder.FrequentSkill.WYVERN_BREATH.getSkill());
				return null;
			}
			htmltext = "nopoint.htm";
		}
		else if (event.equalsIgnoreCase("warrior"))
		{
			...
			else if (player.getPcBangPoints() >= 5600)
			{
				...
				npc.setTarget(player);
				npc.doCast(SkillHolder.getInstance().getInfo(4397, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4393, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4392, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4391, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4404, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4396, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4405, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4403, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4398, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4394, 4));
				npc.doCast(SkillHolder.getInstance().getInfo(4402, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4406, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4399, 3));
		...
		else if (event.equalsIgnoreCase("pet_warrior"))
		{
			...
			else if (player.getPcBangPoints() >= 4000)
			{
				...
				npc.setTarget(player.getSummon());
				npc.doCast(SkillHolder.getInstance().getInfo(4397, 1));
				npc.doCast(SkillHolder.getInstance().getInfo(4393, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4392, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4391, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4404, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4396, 1));
				npc.doCast(SkillHolder.getInstance().getInfo(4405, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4403, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4398, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4394, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4402, 1));
				npc.doCast(SkillHolder.getInstance().getInfo(4406, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4399, 2));
		...
		else if (event.equalsIgnoreCase("mage"))
		{
			...
			else if (player.getPcBangPoints() >= 3000)
			{
				...
				npc.doCast(SkillHolder.getInstance().getInfo(4392, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4391, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4395, 4));
				npc.doCast(SkillHolder.getInstance().getInfo(4401, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4400, 3));
				htmltext = "skill_info.htm";
			}
			else
			{
		...
		else if (event.equalsIgnoreCase("pet_mage"))
		{
			...
			else if (player.getPcBangPoints() >= 2100)
			{
				...
				npc.doCast(SkillHolder.getInstance().getInfo(4392, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4391, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4395, 3));
				npc.doCast(SkillHolder.getInstance().getInfo(4401, 2));
				npc.doCast(SkillHolder.getInstance().getInfo(4400, 2));
				htmltext = "pet_skill_info.htm";
			}
			else
			{
