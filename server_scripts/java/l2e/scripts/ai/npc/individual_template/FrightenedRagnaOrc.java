...
public final class FrightenedRagnaOrc extends AbstractNpcAI
{
	...
	// Skill
	private static final SkillsHolder SKILL = new SkillsHolder(6234, 1);
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		switch (event)
		{
			case "say":
				...
				final NpcStringId mssg = getRandomBoolean() ? NpcStringId.I_DONT_WANT_TO_FIGHT : NpcStringId.IS_THIS_REALLY_NECESSARY;
				broadcastNpcSay(npc, Say2.NPC_ALL, mssg);
				break;
			case "reward":
